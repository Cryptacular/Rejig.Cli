...
running command...
$ rejig (--version)
rejig-cli/0.7.0 darwin-x64 node-v16.6.2
$ rejig --help [COMMAND]
USAGE
  $ rejig COMMAND
...
...
_See code: [dist/commands/process.ts](https://github.com/Cryptacular/Rejig.Cli/blob/v0.7.0/dist/commands/process.ts)_
<!-- commandsstop -->
